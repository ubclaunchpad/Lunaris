...
export default function GamePage({ params }: GamePageProps) {
            ...
            try {
                ...
                while (retries < maxRetries) {
                    try {
                        ...
                        const session = streamData as any;
    ...
    const handlePlayClick = async () => {
        ...
        try {
            ...
            setDeploymentStatus(`Deploy error: ${error instanceof Error ? error.message : "Unknown error"}`);
            setIsDeploying(false);
        }
    };
        ...
        <div>
            <button
                ...
                <div className="flex gap-12 mb-16">
                    {/* Game Cover Image */}
                    <div className="w-[489px] h-[321px] rounded-[10px] overflow-hidden shadow-[8px_7px_20px_0px_rgba(0,0,0,0.12)] shrink-0">
                        <img
                            src={game.image}
                            alt={game.name}
                ...
                <div className="mb-12">
                    ...
                    >
                        ...
                        ) : game.playable ? 'Play' : 'Not Available'}
                    </button>
                    ...
                    {isDeploying && deploymentStatus && (
                        <div className="mt-4 bg-blue-900/50 border border-blue-700 rounded-lg p-4">
                            ...
                            <p className="text-xs text-blue-400 mt-2">
                                This may take 2-3 minutes. You'll be automatically redirected when ready.
                            </p>
                        </div>
                    )}
                </div>
